...
aks_node_counts               = { primary = 3, secondary = 3 }
aks_node_vm_sizes             = { primary = "Standard_D4s_v5", secondary = "Standard_D4s_v5" }
aks_node_min_counts           = { primary = 2, secondary = 2 }
aks_node_max_counts           = { primary = 8, secondary = 8 }
aks_service_cidrs             = { primary = "10.170.0.0/16", secondary = "10.180.0.0/16" }
aks_dns_service_ips           = { primary = "10.170.0.10", secondary = "10.180.0.10" }
